<template>
  <section class="relative min-h-screen overflow-hidden">
    ...
    <div class="relative z-10 max-w-[1240px] mx-auto px-4 lg:px-12 py-8 md:py-12">
        ...
        <div class="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-7 fade-up">
          ...
          <div v-else class="space-y-3 max-h-[520px] overflow-y-auto pr-1">
            <div v-for="entry in myEntries" :key="entry.id"
              ...
              <div class="flex items-center gap-2 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-200">
