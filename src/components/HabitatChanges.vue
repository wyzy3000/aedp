    ...
    <div class="max-w-[1240px] mx-auto px-8 lg:px-12 w-full relative z-10">
      ...
      <div class="mb-10 fade-up" ref="headerRef">
        <div class="flex items-center gap-2 mb-3">
          ...
          <span class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-neutral-500 transition-colors">Module 02 · Habitat</span>
        </div>
        ...
        <p class="mt-2 font-display font-medium text-lg italic text-savanna-600 dark:text-savanna-600 transition-colors">Hali ya miti na makazi</p>
